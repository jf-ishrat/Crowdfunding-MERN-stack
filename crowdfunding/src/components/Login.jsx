                ...
                <form method="post">
                    ...
                    <div class="form-group">
                        <div class="input-group">
                            ...
                            <input type="text" class="form-control" name="email" value={email} onChange={(e) => setEmail(e.target.value)} placeholder="email" required="required" />
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="input-group">
                    ...
                    <div class="form-group">
                        <button type="submit" onClick={SubmitForm} class="btn btn-primary login-btn btn-block">Log in</button>
                    </div>
                    <div class="clearfix">
